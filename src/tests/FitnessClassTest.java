...
//        Member member3 = new Member("John", "Doe", new Date("12/12/2012"), Location.toLocation("Piscataway"));
//
//        assertTrue(testClass.add(member1));
//        assertTrue(testClass.add(member2));
//        assertFalse(testClass.add(member3));
